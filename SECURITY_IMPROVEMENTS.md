...
### 2. Update Secret Manager (for Cloud Run)

Update the Terraform variable or manually update in GCP Secret Manager:
```bash
# Generate new admin secret
python -c "import secrets; print(secrets.token_urlsafe(32))"

# Update in Secret Manager
gcloud secrets versions add odace-admin-secret --data-file=- <<< "YOUR_GENERATED_SECRET"
```
